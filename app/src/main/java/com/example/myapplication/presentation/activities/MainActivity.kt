...
import com.example.myapplication.utils.RecyclerType
import com.example.myapplication.utils.ScrollingDirection
import com.example.myapplication.utils.adapters.MyAdapter
import com.example.myapplication.utils.bottomsheets.BottomSheetDialog
            ...
            loadMoreEndItems = { _, onComplete ->
                lifecycleScope.launch {
                    mainViewModel.fetchTrendingData(
                        ...
                        onUpdateScrollState = {
                            val layoutManager = binding.trendingRecycler.layoutManager as LinearLayoutManager
                            recyclerViewPosition = layoutManager.findFirstVisibleItemPosition()
                            recyclerViewOffset = layoutManager.findViewByPosition(recyclerViewPosition)?.top ?: 0
                        }
                    )
                }
            },
            ...
            showPopUp(
                ...
                onSwitchAccountClick = {
                    mainViewModel.user2List.observe(this, Observer { items ->
                        val bottomSheet = BottomSheetDialog(userList = items, mainViewModel = mainViewModel)
